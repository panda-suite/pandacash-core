...
var _listen = function (opts, cb) { return __awaiter(_this, void 0, void 0, function () {
    var pandaCashCore;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pandaCashCore = new PandaCashCore_1.default(opts);
                return [4 /*yield*/, pandaCashCore.startNode()];
            case 1:
                _a.sent();
                return [4 /*yield*/, pandaCashCore.seedAccounts()];
            case 2:
                _a.sent();
                if (opts.enableLogs) {
                ...
                return [2 /*return*/, Promise.resolve(pandaCashCore)];
        }
    });
}); };
/**
